...
function SuccessPage({ signOutUser }) {
  // console.log("signOutUser prop:", signOutUser);

  return (
    <div className="min-h-screen text-black bg-background-color">
      {/* Navigation */}
      ...
      <section className="container flex flex-col items-center px-4 py-12 mx-auto mb-8 md:flex-row">
        ...
        <div className="w-full pl-0 mt-8 md:w-1/2 md:pl-8 md:mt-0">
          ...
          <Typewriter
            ...
            backgroundColor="text-xl  bg-background-text mr-16 px-10 py-8 rounded-2xl"
